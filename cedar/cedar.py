...
def tempdir(*a, **k):
    ...
    try:
        ...
        print("TODO Handle Remove Temp Directory")
        #shutil.rmtree(tmp)


class Cedar:
    def prepareBiomeCoords(self):
        ...
        for b_x, b_z, b_data, b_meta, b_height, b_biome in world.carto(radius, center, resolution):
            ...
            img.close()
        '''
    def __init__(self, center=None, jar=None, output='{seed}.png', radius=1000, resolution=2, seed=None, verbosity=2):
